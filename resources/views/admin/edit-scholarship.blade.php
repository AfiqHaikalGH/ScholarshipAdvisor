        ...
        <div class="relative w-full rounded-3xl overflow-hidden flex items-center mb-8 shadow-md h-[140px] md:h-[180px] mt-2"
            ...
            <div class="relative z-10 px-8 md:px-12 max-w-xl">
                <div class="flex items-center gap-4 mb-3">
                    ...
                    <h1 class="text-2xl md:text-3xl font-extrabold text-[#0B1221] tracking-tight leading-tight">Update Scholarship</h1>
                </div>
                <p class="text-sm text-gray-800 leading-relaxed font-semibold">Update the detailed requirements and information for this scholarship.</p>
            </div>
        </div>
            ...
            <div class="w-full lg:w-[280px] shrink-0 sticky top-24 z-20 hidden lg:block">
                <nav class="space-y-6 relative">
                    ...
                    <button type="button" @click="scrollTo('section-submit')" class="relative z-10 flex items-start gap-4 w-full text-left group">
                        ...
                        <div class="mt-1">
                            <p class="text-sm font-bold transition-colors" :class="activeSection === 'section-submit' ? 'text-[#2C3BEB]' : 'text-gray-700 group-hover:text-[#2C3BEB]'">Update</p>
                            <p class="text-xs text-gray-500 mt-0.5">Review &amp; update</p>
                        </div>
                    </button>
                </nav>
                ...
                <div class="mt-12 bg-blue-50/50 border border-blue-100/60 rounded-2xl p-5 relative overflow-hidden group hover:border-blue-200 transition-colors">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-[11px] leading-relaxed text-blue-800/80 font-medium">Leave fields blank if they don't apply. Changes will update the scholarship instantly.</p>
                    </div>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('scholarships.update', $scholarship->id) }}" class="space-y-8"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @if(auth()->user()->role === 'representative')
                            <input type="text" name="provider" value="{{ old('provider', $scholarship->provider) }}" readonly
                    ...
                    <div class="col-span-full md:col-span-1">
                        ...
                        <input type="url" name="apply_url" placeholder="https://..."
                            value="{{ old('apply_url', $scholarship->apply_url) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-[#2C3BEB] focus:border-[#2C3BEB]">
                    </div>
                    <div class="col-span-full md:col-span-1">
            ...
            <div id="section-submit" class="form-section scroll-mt-28 bg-gray-50 rounded-2xl border-2 border-gray-200 p-6 md:p-8">
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <h2 class="text-2xl font-extrabold text-gray-900 mb-2">Update Scholarship</h2>
                    <p class="text-sm text-gray-600 max-w-sm mb-6">Review the details above, then click update to save your changes.</p>
