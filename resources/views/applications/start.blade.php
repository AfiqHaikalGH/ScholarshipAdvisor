                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-20 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm text-gray-500 mt-1 max-w-xs mx-auto">Update your <a href="{{ route('qualifications.index') }}" class="text-indigo-600 font-bold hover:underline decoration-2">Qualifications</a> to see scholarships that fit you.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
