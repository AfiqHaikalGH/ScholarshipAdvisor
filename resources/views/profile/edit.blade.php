<x-app-layout>
    <div class="max-w-4xl mx-auto">
        <div class="flex flex-col items-center text-center mb-10 gap-2">
            <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">Update Profile</h1>
            ...
            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
                <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="phone_num" name="phone_num" type="text" class="mt-1 block w-full"
                                :value="old('phone_num', auth()->user()->phone_num)" autocomplete="tel" />
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-50">
                        <x-primary-button
                            class="!bg-[#2C3BEB] hover:!bg-[#2130d4]">{{ __('Save Changes') }}</x-primary-button>
